EGI <- function(T, model, method=NULL, method.param=NULL, 
  ...
  if (method == "timse" || method == "imse" || method == "sur" || method == "jn" || method == "vorob") return(EGIparallel(T=T,model=model,method = method,method.param = method.param,fun = fun,iter = iter,
